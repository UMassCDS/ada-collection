...
# Path to the Caladrius repo root directory
CALADRIUS=./caladrius
...
setup-discount --input $WORKSPACE/buildings-predictions.geojson --outdir $WORKSPACE/tiles --out-csv $WORKSPACE/annotations.csv